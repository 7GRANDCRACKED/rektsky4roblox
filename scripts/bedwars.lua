...
local lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/7GRANDCRACKED/rektsky4roblox/main/NewRektskyUiLib.lua"))()
...
pcall(function()
    whiteliststhing = loadstring(game:HttpGet("https://raw.githubusercontent.com/7GRANDCRACKED/rektsky4roblox/main/whitelist.lua"))()
end)
...
local function getcustomassetfunc(path)
    if not betterisfile(path) then
        ...
        local req = requestfunc({
            Url = "https://raw.githubusercontent.com/7GRANDCRACKED/rektsky4roblox/main/"..path:gsub("rektsky/sound/mc", "sound/mc"),
            Method = "GET"
        })
